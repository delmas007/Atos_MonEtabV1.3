...
public class OptionProfesseur {
     static ProfesseurServiceImpl professeurr = new ProfesseurServiceImpl();
    ...
    public static void ajouterProfesseurr()  {
        ...
        String prochainCours = "";
        String sujetProchaineReunion = "";
        int id = 0;
        Professeur professeur = new Professeur(vacant,matiereEnseigne,prochainCours,sujetProchaineReunion,id,nom,prenom,date1,ville,telephone);
        professeurr.save(professeur);
                ...
                """
                    ...
                    ******************************************************   
                    MENU:
                        ...
                        4: Modifier numero de telephone
                        5: Retour
                        6: Accueil
    ...
    public void listerProfesseur(Instant debut) {
        List<Professeur> professeurs = professeurr.getAll();
    ...
    public void modProfesseur(Instant debut, String valeurModifiee) {
        ...
        while (continuer) {
            int id = idProfesseur();
            Professeur ele = professeurr.getOne(id);
            while (ele == null) {
            ...
            Professeur nouv = professeurr.update(ele);
    ...
    public Professeur exceptionInt(Professeur ele) {
        ...
        while (!validId) {
            try {
                System.out.print("Entrez le nouveau numero du professuer : ");
                id = scanner.nextInt();
                ele.setTelephone(id);
                validId = true;
